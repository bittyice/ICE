...
import { Space, Button, Input, TreeSelect, Tag, Divider, Modal, DatePicker, Toast } from 'antd-mobile';
...
import { PurchaseOrderApi, PurchaseOrderEntity, purchaseOrderSlice, supplierSlice, IceStateType, LabelValues, enums } from 'ice-core';
...
class PurchaseOrder extends React.Component<Props> {
    ...
    fetchInvalid = (row: any) => {
        Modal.confirm({
            ...
            onConfirm: async () => {
                await PurchaseOrderApi.invalid(row.id);
                Toast.show("作废成功");
