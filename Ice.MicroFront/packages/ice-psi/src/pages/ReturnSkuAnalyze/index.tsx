...
class ReturnSkuAnalyze extends React.Component<{
    suppliers: Array<any>
}> {
    ...
    render() {
        return <CommonPage
            ...
            slice={psiReduxOthers.returnSkuReport.slice}
...
export default () => {
    ...
    const curPageDatas = useSelector((state: IceStateType) => state.returnSkuReport.curPageDatas);
