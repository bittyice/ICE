...
import { enums, IceStateType, LabelValues, PaymentMethodEntity, paymentMethodSlice, ProductInfoHelper } from 'ice-core';
...
class SaleReturnDetailReport extends React.Component<Props> {
    state = {
    ...
    fetchDatas = () => {
        ...
        return iceFetch<Array<any>>('/api/psi/sale-return-detail-report', {
            method: 'GET',
            urlParams: {
                startTime: start,
                endTime: end,
    ...
    exportFile = () => {
        ...
        exportXLSX(newDates, undefined, '退货明细表.xlsx');
    }
