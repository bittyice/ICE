...
import { LabelValues, enums, ProductInfoHelper, IceStateType, paymentMethodSlice, PaymentMethodEntity } from 'ice-core';
...
class SaleDetailReport extends React.Component<Props> {
    state = {
    ...
    fetchDatas = () => {
        ...
        return iceFetch<Array<any>>('/api/psi/sale-detail-report', {
            method: 'GET',
            urlParams: {
                startTime: start,
                endTime: end,
