...
import { wmsReduxOthers, IceStateType, ProductInfoHelper, LabelValues, enums } from 'ice-core';
...
class OutboundSkuAnalyze extends React.Component<{
    ...
    tableName = `W-OutboundSkuAnalyze`;
    ...
    filterColumn: FilterColumnTypes = [{
        ...
        filter: (props) => <SelectFilter
            {...props}
            filterValues={LabelValues.OutboundOrderStatus}
        />
    }, {
        title: '订单创建时间',
    ...
    render() {
        return <CommonPage
            ...
            slice={wmsReduxOthers.outboundSkuReport.slice}
...
export default () => {
    ...
    const curPageDatas = useSelector((state: IceStateType) => state.outboundSkuReport.curPageDatas);
